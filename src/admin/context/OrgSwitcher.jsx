    ...
    <div className="orgsw" ref={wrapRef}>
      ...
      {open && (
        <div className="orgsw__dropdown" role="menu">
          <div className="orgsw__section">
            <div className="orgsw__section-label">Active</div>
            <div className="orgsw__item orgsw__item--active" role="menuitemradio" aria-checked="true">
              <span className="orgsw__chip orgsw__chip--sm" style={{ background: activeOrg.brand_color || '#FD6F46' }} />
              <span className="orgsw__item-name">{activeOrg.name}</span>
              <svg className="orgsw__check" width="12" height="12" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          {others.length > 0 && (
            <div className="orgsw__section">
              <div className="orgsw__section-label">Switch to</div>
              {others.map(o => (
                <button
                  key={o.id}
                  type="button"
                  ...
                  role="menuitem"
                >
                  <span className="orgsw__chip orgsw__chip--sm" style={{ background: o.brand_color || '#FD6F46' }} />
