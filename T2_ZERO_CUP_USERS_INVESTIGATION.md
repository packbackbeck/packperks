...
- **In-app-browser handling** — use the new `in_app` signal to prompt "open in your normal browser" before scanning, so cups don't strand; push email-link binding to consolidate identities.
