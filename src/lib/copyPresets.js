  ...
  deposit: {
    ...
    terms: {
      ...
      points: [
        ...
        'To claim a reward you first add and verify your email (we send you a verification code), then upload a clear photo of the printed store receipt for the reward item.',
        'We accept genuine printed store/till receipts that clearly show the reward item and are dated within the allowed claim period.',
        ...
        'An automated check pre-screens your photo, but a PackPerks team member makes the final decision. Approval usually takes a few days.',
  ...
  byo: {
    ...
    terms: {
      ...
      points: [
        ...
        'To keep things fair, a daily collection limit applies. Cups beyond that limit may be held for a quick review before they are credited.',
        'Each store keeps its own cup balance. Cups you collect at one venue stay with that venue, and you can switch your reward goal any time before you claim.',
        ...
        'We accept genuine printed store or till receipts that clearly show the reward item and are dated within the allowed claim period.',
        ...
        'Each receipt can be used once. A receipt already used for a claim can’t be submitted again.',
        'An automated check pre-screens your receipt scan, but an admin makes the final decision. Approval usually takes a few days.',
        ...
        'Your Tikkie Cashback link expires after a limited time, so please collect your cashback promptly. If it expires, the claim may need to be reviewed again before a new link can be issued.',
