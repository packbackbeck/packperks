...
const FEATURES = [
  ...
  { id: 'f-staff-app',    name: 'Staff app',               desc: 'Who can make cup QR codes on a phone', group: 'Master',   page: 'master', section: 'staff', icon: Icon.user, keywords: 'staff app packperks staff qr phone barista employees vendors add email nyu' },
