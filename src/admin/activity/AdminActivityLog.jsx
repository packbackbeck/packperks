...
const ACTION_LABELS = {
  ...
  'staff.invite':        { tone: 'primary', label: 'Added staff to the staff app' },
  'staff.request':       { tone: 'warning', label: 'Asked for staff app access' },
  'staff.joined':        { tone: 'success', label: 'Joined the staff app' },
  'staff.approve':       { tone: 'success', label: 'Approved a staff app request' },
  'staff.decline':       { tone: 'danger',  label: 'Declined a staff app request' },
  'staff.pause':         { tone: 'warning', label: 'Paused a staff member' },
  'staff.resume':        { tone: 'success', label: 'Resumed a staff member' },
  'staff.block':         { tone: 'warning', label: 'Paused a staff member' },
  'staff.unblock':       { tone: 'success', label: 'Resumed a staff member' },
  'staff.remove':        { tone: 'danger',  label: 'Removed a staff member' },
  'staff.app_on':        { tone: 'success', label: 'Switched the staff app on' },
  'staff.app_off':       { tone: 'warning', label: 'Switched the staff app off' },
